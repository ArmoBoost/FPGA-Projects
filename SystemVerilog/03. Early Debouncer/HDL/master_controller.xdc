...
## LEDs
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports db]
...
connect_debug_port u_ila_0/probe1 [get_nets [list db_OBUF]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe3 [get_nets [list sw_IBUF]]
